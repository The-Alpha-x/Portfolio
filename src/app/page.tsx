  ...
  return (
    <VantaBackground>
      <div className="flex flex-col min-h-screen  bg-black/70">
        {/* Navigation */}
        <header className="sticky top-0 z-50 backdrop-blur-md bg-[#0c051b]/60 border-b border-cyan-500/20">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Rocket className="w-6 h-6 text-cyan-400 animate-pulse" />
              <span className="font-bold text-xl tracking-wider text-white">NIRMAL AMANDA</span>
            </div>
        ...
        {/* Hero Section */}
        <section id="about" className="flex-1 flex flex-col justify-center items-center text-center px-4 sm:px-6 py-10 sm:py-10 w-full mx-auto">

          <div className="flex flex-col lg:flex-row justify-center items-center w-full max-w-7xl gap-6 lg:gap-4">
            {/* Front End Section */}
            <div className="flex justify-center lg:justify-end items-center w-full flex-1">
              <div className="flex-1 flex flex-col items-center lg:items-end text-center lg:text-right space-y-3 sm:space-y-4 p-4 sm:p-6 rounded-2xl group/frontend">
                ...
                <div className="flex flex-wrap gap-2 justify-center lg:justify-end pt-2">
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-cyan-950/80 border border-cyan-700/50 text-cyan-300 transition-all duration-300 hover:scale-110 hover:bg-cyan-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(34,211,238,0.6)] cursor-pointer">React / Next.js</span>
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-cyan-950/80 border border-cyan-700/50 text-cyan-300 transition-all duration-300 hover:scale-110 hover:bg-cyan-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(34,211,238,0.6)] cursor-pointer">TypeScript</span>
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-cyan-950/80 border border-cyan-700/50 text-cyan-300 transition-all duration-300 hover:scale-110 hover:bg-cyan-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(34,211,238,0.6)] cursor-pointer">Tailwind CSS</span>
                </div>
              </div>
            </div>

            {/* Cyborg Hero Image - Automatically Responsive */}
            <div className="flex justify-center items-center w-full max-w-[280px] sm:max-w-[380px] md:max-w-[450px] lg:max-w-[500px] flex-shrink shrink-0">
              <img
                src="./portfolioHero.png"
                alt="Hero Background"
                className="w-full h-auto object-contain max-h-[60vh] transform transition-transform duration-300 hover:scale-105 filter hover:drop-shadow-[0_0_30px_rgba(63,209,255,0.4)]"
              />
            </div>

            {/* Back End Section */}
            <div className="flex justify-center lg:justify-start items-center w-full flex-1">
              <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-3 sm:space-y-4 p-4 sm:p-6 rounded-2xl group/backend">
                ...
                <p className="text-md sm:text-sm lg:text-md text-slate-300 max-w-xs leading-relaxed font-light transition-colors group-hover/backend:text-slate-100">
                  Architecting robust REST APIs, cloud infrastructure & scalable databases.
                </p>
                <div className="flex flex-wrap gap-2 justify-center lg:justify-start pt-2">
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-indigo-950/80 border border-indigo-700/50 text-indigo-300 transition-all duration-300 hover:scale-110 hover:bg-indigo-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(129,140,248,0.6)] cursor-pointer">Node.js / Express</span>
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-indigo-950/80 border border-indigo-700/50 text-indigo-300 transition-all duration-300 hover:scale-110 hover:bg-indigo-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(129,140,248,0.6)] cursor-pointer">PostgreSQL / MongoDB</span>
                  <span className="px-2.5 py-1 text-xs font-mono rounded-md bg-indigo-950/80 border border-indigo-700/50 text-indigo-300 transition-all duration-300 hover:scale-110 hover:bg-indigo-500 hover:text-slate-950 hover:shadow-[0_0_15px_rgba(129,140,248,0.6)] cursor-pointer">REST API</span>
                </div>
              </div>
            </div>
          ...
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-cyan-950/60 border border-red-500/30 text-red-400 text-xs sm:text-sm font-mono mb-4 backdrop-blur-md shadow-[0_0_15px_rgba(34,211,238,0.2)]">
            <span className="w-2 h-2 rounded-full bg-red-500 animate-ping" />
            <span>Hello, I'm <strong className="text-white font-semibold">Nirmal Amanda</strong></span>
          </div>

          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mt-4 mb-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-300 max-w-2xl mb-8 leading-relaxed font-light">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#projects"
              className="px-8 py-3.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold shadow-lg shadow-cyan-500/25 transition-all transform hover:-translate-y-0.5"
            >
              Explore Work
            </a>
            <a
              href="#contact"
              className="px-8 py-3.5 rounded-xl border border-slate-700 bg-slate-900/60 hover:bg-slate-800/80 text-white font-semibold backdrop-blur-md transition-all"
            >
              Get In Touch
            </a>
          </div>
        ...
        {/* Tech Stack Section */}
        <section id="stack" className="px-6 py-20 max-w-6xl mx-auto w-full">
            ...
            {filterTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 text-xs sm:text-sm font-medium rounded-xl border transition-all duration-300 ${isActive
          ...
          {/* Square Cards Container (Center Aligned) */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-5 min-h-[220px] transition-all duration-300">
            {filteredItems.map((item) => {
              return (
                <div
                  key={item.name}
                  className="group relative flex flex-col items-center justify-center p-4 sm:p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:-translate-y-1.5 hover:border-cyan-500/50 hover:bg-slate-900/80 hover:shadow-[0_0_20px_rgba(34,211,238,0.25)] cursor-pointer text-center w-[calc(50%-0.6rem)] sm:w-40 md:w-44 aspect-square"
                >
                  <div className="p-3 mb-2 rounded-xl bg-slate-800/60 group-hover:bg-cyan-500/20 transition-all duration-300 transform group-hover:scale-110 flex items-center justify-center">
                    <img
                      src={item.iconUrl}
                      alt={item.name}
                      className={`w-7 h-7 sm:w-8 sm:h-8 object-contain transition-all duration-300 ${item.invert ? "invert opacity-90 group-hover:opacity-100" : ""
                        }`}
                    />
                  </div>
                  <h4 className="font-semibold text-xs sm:text-sm text-slate-100 group-hover:text-white transition-colors">
                    {item.name}
                  </h4>
                  <span className="text-[10px] sm:text-[11px] text-slate-400 font-mono mt-1 group-hover:text-cyan-300 transition-colors">
                    {item.desc}
                  </span>
                </div>
              );
        ...
        {/* Projects Section */}
        <section id="projects" className="px-6 py-20 max-w-6xl mx-auto w-full">
        ...
        {/* Contact Section */}
        <section id="contact" className="px-6 py-20 max-w-4xl mx-auto w-full text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-slate-900/70 via-slate-900/50 to-slate-950/90 border border-cyan-500/20 backdrop-blur-xl shadow-2xl relative overflow-hidden">
            ...
            <p className="text-slate-300 text-sm sm:text-base mb-8 max-w-xl mx-auto font-light">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-10">
              ...
              <a
                href="tel:+1234567890"
                className="group flex items-center space-x-3 px-5 py-3 rounded-2xl bg-slate-800/60 border border-slate-700/60 hover:border-cyan-400/60 hover:bg-slate-800/90 transition-all duration-300 transform hover:-translate-y-1 w-full sm:w-auto justify-center"
              >
                <div className="p-2.5 rounded-xl bg-cyan-500/10 group-hover:bg-cyan-500 group-hover:text-slate-950 text-cyan-400 transition-all duration-300">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#0077b5]/30 flex items-center justify-center"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:text-white hover:bg-[#1877f2] hover:border-[#1877f2] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#1877f2]/30 flex items-center justify-center"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:text-white hover:bg-slate-700 hover:border-slate-500 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-cyan-500/20 flex items-center justify-center"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
